    ...
    try {
      ...
      if (mode === 'create') {
        ...
        const registryAddress =
          COURSE_REGISTRY_ADDRESSES[
            chainId as keyof typeof COURSE_REGISTRY_ADDRESSES
          ]
        ...
        if (
          ...
          throw new Error(
            `Course registry not deployed on chain ${chainId}. Please deploy the contract first.`,
          )
        }
            ...
            <div className="mb-6 p-4 bg-green-900/30 border border-green-700/50 rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <p className="text-green-300 text-sm">
                  Course {mode === 'create' ? 'created' : 'updated'}{' '}
                  successfully!
                </p>
              </div>
            </div>
