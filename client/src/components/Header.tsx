...
function WalletInfo({ address, owcBalance }: WalletInfoProps) {
  ...
  return (
    <div className="flex items-center gap-3 bg-gray-800/50 border border-gray-700/50 rounded-xl px-4 py-2.5 backdrop-blur-sm">
...
export default function Header() {
  ...
  return (
    <header className="w-full border-b border-gray-800/20 bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-gray-900/60">
