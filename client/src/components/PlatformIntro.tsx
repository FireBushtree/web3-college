    ...
    <div className="text-center py-16 bg-gradient-to-br from-pink-500/10 via-violet-500/10 to-cyan-500/10 rounded-3xl border border-gray-800/30">
      <div className="mb-8">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
          Learn cutting-edge Web3 technologies and earn OWC tokens upon course completion. 
          Stake your earned tokens for additional rewards and join our community of learners and builders shaping the decentralized future.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-400 text-center">Access high-quality Web3 courses from industry experts</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-400 text-center">Finish courses and demonstrate your knowledge</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-400 text-center">Receive OWC tokens as rewards for your achievements</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-400 text-center">Stake your OWC tokens to earn additional passive rewards</p>
        </div>
      </div>
    </div>
  )
